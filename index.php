    ...
    <div class="container">
      <div class="row">
        <div class="offset-md-2 col-md-8 text-center">
          ...
          <h2>User-friendly Trading and Investing Products.</h2>
          <p>3L+ traders and investors in India use our stable and reliable platforms regularly.
          3L+ traders and investors in India use our stable and reliable platforms regularly.
          </p>
...
<div class="tradingview-widget-container">
  ...
  <div class="tradingview-widget-copyright"><a href="https://in.tradingview.com/markets/" rel="noopener" target="_blank"><span class="blue-text">Markets today</span></a> by vendXtrade</div>
...
<!-- TradingView Widget END -->
  ...
  <div class="landing-info-one landing-info-one-bg mtb100">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h2>The most advance and secure trading platform.</h2>
      ...
      <div class="row">
        <div class="col-md-5">
          ...
          <div class="tradingview-widget-container tradingview-gain-and-loser">
            <div class="tradingview-widget-container__widget"></div>
            <script type="text/javascript" src="../s3.tradingview.com/external-embedding/embed-widget-hotlists.js"
              async>
                {
                  "colorTheme": "light",
                    "dateRange": "12M",
        ...
        <div class="container">
          <div class="row">
        <div class="col-md-6">
          <img src="assets\img\photo.jpeg" alt="img" srcset="">
        </div>
        <div class="col-md-6">
  ...
  <div class="landing-feature">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2>Here are a few reasons why <br> you should choose vendXtrade</h2>
        </div>
        <div class="col-md-4">
      ...
      <div class="row">
        <div class="offset-md-1 col-md-10">
          <div class="landing-sub-content">
            <h2>Become part of a global community of people who have found their path to the crypto world with vendXtrade
            </h2>
